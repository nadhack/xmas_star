...
uint16_t setWait( uint16_t wait ) {
  return wait - (NUMBER_STARS * 5);
}
...
void loop() {
  ...
  switch (showType) {
    case 0: rainbowCycle(20);
      break;
    case 1:
      colorWipeIn(strip.Color(255, 0, 0), setWait(500));  // Red
      delay(100);
      colorWipeIn(strip.Color(0, 0, 0), setWait(500));  // Black/off
      break;
    case 2:
      colorWipeIn(strip.Color(0, 255, 0), setWait(250));  // Green
      delay(100);
      colorWipeOut(strip.Color(0, 0, 0), setWait(500));  // Black/off
      break;
    case 3:
      colorWipeIn(strip.Color(0, 0, 255), setWait(100));  // Blue
      delay(100);
      colorWipeIn(strip.Color(0, 0, 0), setWait(500));  // Black/off
      break;
